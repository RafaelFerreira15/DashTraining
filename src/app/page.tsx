      ...
      <div className="flex flex-col hidden sm:flex w-10/12">
        <Tabs defaultValue="Registrar" className="">
          <TabsList className="grid w-full grid-cols-2 bg-slate-800">
            <TabsTrigger value="Registrar" className="bg-slate-800 text-white data-[state=active]:bg-gray-950 data-[state=active]:text-white">Registrar</TabsTrigger>
            <TabsTrigger value="Login" className="bg-slate-800 text-white data-[state=active]:bg-gray-950 data-[state=active]:text-white">Login</TabsTrigger>
          </TabsList>
